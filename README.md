...
The core data is located in the link; you can download it directly and place it in the specified folder for immediate use (https://doi.org/10.6084/m9.figshare.32494290). (Includes...ALLCITIES_train_xy_monthly_S10_40pct_ntlmask_TOP100, Köppen_data, selected_cities_fullinfo, typical_timeseries_fast)
